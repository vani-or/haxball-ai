(function(qc) {
    ...
    function ba(a) {
        ...
        function g(a) {
            for (var b = 0, c = 0; c < t.length; ) {
                ...
                var e = d == a;
                e && (ba.Ul = b);
                d.Zg.classList.toggle("selected", e);
        ...
        m();
        var Q = n.A.qg.L(), q = k.get("presskey"), r, p = k.get("inputsec");
        r = function() {
            u.Af(p);
            var a = b("Up");
            p.appendChild(a);
    ...
    function Ya(a) {
        ...
        ;
        this.Qh(c.get("red-list"), this.Cl, q.da, a);
        this.Qh(c.get("blue-list"), this.Hj, q.xa, a);
        this.Qh(c.get("spec-list"), this.hm, q.Ia, a);
    ...
    function ha(a) {
        ...
        k.onclick = function(b) {
            a.$q((b.pageX - k.offsetLeft) / k.clientWidth * a.ih * a.lf);
            c.Uf || (c.Uf = !0,
            c.Np(),
            c.al())
        }
        ...
        k.onmousemove = function(b) {
            ...
            t.textContent = ha.Sk(a.lf * a.ih * b);
    ...
    function P(a) {
        ...
        Ka.Yo().then(function(d) {
            null == P.ug && (P.ug = window.document.createElement("div"),
            c.He.appendChild(P.ug),
            P.xq = d.render(P.ug, {
                sitekey: a,
                callback: function(a) {
                    y.i(P.Bl, a)
    ...
    function Aa(a) {
        ...
        var c = u.Ea(this.g);
        this.Za = c.get("list");
        this.Sh = c.get("join-btn");
        this.ti = c.get("reset-btn");
        a == q.Ia && this.ti.remove();
        this.Sh.textContent = "" + a.w;
    ...
    function Rb() {
        ...
        this.Bh = this.Of.getContext("2d", null);
            ...
            if (!(1 > b.length)) {
                ...
                c.onload = function() {
                    try {
                        ...
                        b instanceof SyntaxError ? y.i(a.ci, "SyntaxError in line: " + K.xe(b.lineNumber)) : b instanceof Bb ? y.i(a.ci, b.pp) : y.i(a.ci, "Error loading stadium file.")
                    }
                }
                ;
                c.readAsText(b)
    ...
    function gb(a) {
        ...
        ;
        this.Pe.onclick = function() {
            Cb.i(b.bi, b.Nb, b.mi.value, b.Fj)
        }
        ;
    ...
    function ja(a) {
        ...
        this.g = u.Ga(ja.N);
        a = u.Ea(this.g);
        this.Gh = a.get("gameplay-section");
    ...
    function jb(a) {
        ...
        this.g = u.Ga(jb.N);
        var c = u.Ea(this.g);
        this.rh = c.get("cancel");
        this.Sj = c.get("create");
        this.Ze = c.get("name");
        this.gl = c.get("pass");
        this.Yh = c.get("max-pl");
        ...
        for (a = 2; 21 > a; )
            ...
            c.textContent = "" + a++,
            this.Yh.appendChild(c);
        this.Yh.selectedIndex = 10;
        this.Bj(!1);
        this.C()
    }
    function kb() {
    ...
    function Ub(a, b) {
        this.dh = null;
        this.Es = .025;
        this.ue = this.$g = this.Cf = 0;
        this.Qg = b.createGain();
        this.Qg.gain.value = 0;
    ...
    function Zb() {
        ...
        this.Ch = c("fps_limit", 0);
        this.oh = d("avatar", null, 2);
    ...
    function ca(a) {
        ...
        this.nb = new Ra;
        this.yg = "Waiting for link";
        this.vi = this.Vl = !1;
        this.sd = 0;
        var b = this;
        this.th = new vb(a,function(a) {
            b.j.Pa.Fb(a)
        }
        );
        this.ya = a;
        ...
        ;
        this.j = new ja(a.uc);
        this.Fh = new Gb(this.j,a.T.na(a.uc).w);
        this.Fh.oi(a.T);
    ...
    function Jb(a, b, c) {
        ...
        this.ll = 5;
        this.Fd = -1;
        this.fg = this.Qb = this.Th = this.nk = 0;
        V.call(this, b);
        ...
        this.si();
        this.Th = window.performance.now();
        this.uc = -1
    }
    function Kb(a) {
        this.Hd = a
        ...
        var d = null
          , d = function(e) {
            ...
            c.pc.zd = function(a) {
                ...
                ;
                a.bf = function() {
                    3 != c.pd && y.i(c.cf, Nb.fh("Connection closed"));
                    c.ja()
                }
                ;
                a = window.setTimeout(function() {
                    y.i(c.cf, Nb.fh("Game state timeout"));
                    c.ja()
                }, 1E4);
                c.pe = a;
                c.rf(2)
    ...
    function Ob(a) {
        ...
        var c = null
          , c = function() {
            var a = b.zq - b.wr();
            0 >= a ? b.ja() : (window.clearTimeout(b.rm),
    ...
    function Va(a, b, c) {
        ...
        this.Ph = new Promise(function(a) {
            d.No = a
        }
        );
    ...
    function xb(a, b, c, d, e, f) {
        ...
        this.pa.ai = function(b) {
            ...
            ;
            g.fa.onmessage = G(g, g.Mh);
            g.fa.onopen = function() {
                null != g.cl && g.cl();
                g.pa.Ji();
                g.zi(g.er, g.pa.Sf, e);
                g.pa.hg = G(g, g.wi);
                g.pa.Ph.then(function() {
                    g.Mc(0, null)
                })
            }
        }
    ...
    var Pb = Ab["bas.basnet.FailReason"] = {
        Ef: !0,
        jh: ["PeerFailed", "Rejected", "Cancelled", "Error"],
        $m: {
            wb: 0,
    ...
    xb.prototype = {
        ...
        Mh: function(a) {
            ...
            switch (b) {
            case 1:
                for (var b = a.ic(), c = a.tg(), d = [], e = 0; e < c.length; )
                    d.push(new RTCIceCandidate(c[e++]));
                this.Lh(b, d, a);
                break;
            case 4:
                this.Kh(new RTCIceCandidate(a.tg()))
            }
        },
        Lh: function(a, b) {
            var c = this;
            this.pa.Ji(this.nh ? 1E4 : 4E3);
            this.vh = !0;
    ...
    Va.prototype = {
        ...
        Pj: function() {
            window.clearTimeout(this.pe);
            this.ai = this.zd = this.hg = this.ad = null;
    ...
    Sa.prototype = {
        ...
        Gi: function(a) {
            ...
            function c(a) {
                ...
                ;
                d.fa.onmessage = G(d, d.Mh)
            }
            null == a && (a = "");
            var d = this;
            N.fq(this.sr, "token=" + this.Ag + "&rcr=" + a, N.cn).then(function(a) {
                switch (a.action) {
                case "connect":
                    c(a);
                    break;
        ...
        Lh: function(a) {
            ...
            try {
                ...
                d = 0 != a.B();
                e = a.ic();
                for (var g = a.tg(), l = [], k = 0; k < g.length; )
        ...
        Io: function(a) {
            this.Ag = a.ge(a.o.byteLength - a.a)
        },
        Mc: function(a, b, c) {
            if (!b.dl) {
                0 == a && (b.dl = !0);
    ...
    I.qo = function() {
        try {
            return window.crypto.subtle.generateKey(I.mh, !0, ["sign", "verify"]).then(function(a) {
                var b = a.privateKey;
    ...
    xa.prototype = C(V.prototype, {
        ...
        C: function() {
            ...
            this.Vc = window.performance.now() * this.Ac + this.Ni.Xg(.5) - this.X;
            this.Kj()
        },
        Qf: function() {
            return this.wd() ? (0 > this.bc && (this.bc = 0),
            this.sk(window.performance.now() * this.Ac + this.Ni.Xg(.5) - this.X + this.bc + this.rd, this.rg)) : this.T
        },
        Kj: function() {
            0 > this.Vc && (this.Vc = 0);
        ...
        jq: function(a) {
            ...
            this.cc = a.zb();
            this.Vc = 10;
            for (this.T.ka(a); 0 < a.o.byteLength - a.a; )
                this.zg(this.xm(a));
            window.clearTimeout(this.pe);
            this.rf(3)
        },
    ...
    Lb.prototype = C(V.prototype, {
        ...
        ra: function(a) {
            ...
            this.zg(a);
            this.Ai();
            0 < this.ac.length && this.Bg(this.Wh(a), 1)
        },
        C: function() {
    ...
    vb.prototype = {
        ff: function(a) {
            ...
            case "checksum":
                var d = this.ya.T.S;
                a = d.w;
                d.Oe() ? this.ha('Current stadium is original: "' + a + '"') : (d = J.Sg(d.Oj(), 8),
            ...
            case "clear_bans":
                ...
                break;
            case "clear_password":
                null == this.Cg ? this.ha("Only the host can change the password") : (this.Cg(null),
            ...
            case "kick_ratelimit":
                ...
                break;
            case "set_password":
                2 == a.length && (null == this.Cg ? this.ha("Only the host can change the password") : (this.Cg(a[1]),
    ...
    ca.prototype = {
        ...
        Jc: function() {
            var a = window.performance.now();
            1 == n.A.Ch.L() && 28.333333333333336 > a - this.Yc || (this.Yc = a,
            this.sd++,
            this.sf(),
        ...
        yp: function(a) {
            var b = this;
            this.th.ff(a) || this.Cn.Sn(1, function() {
                var c = new Na;
                c.Rc = a;
                b.ya.ra(c)
            })
    ...
    Gb.prototype = {
        ...
        oi: function(a) {
            ...
            ;
            a.nl = function(a, b) {
                var d = null != c.Oh && -1 != b.indexOf(c.Oh);
    ...
    wa.prototype = {
        ...
        Wa: function(a) {
            ...
            if (null != this.Vh)
                try {
                    var b = this.Pr(a);
                    null == b ? this.Vh.removeItem(this.w) : this.Vh.setItem(this.w, b)
                } catch (c) {}
        },
        f: wa
    };
    ...
    v.qq = function() {
        var a = Hb.L()
          ...
          , c = a.get("p");
        a.get("v");
        null != b ? null != c ? v.Ah(b) : v.Nf(b) : v.Mb()
    }
    ;
    v.Mb = function() {
        var a = new Ba(n.A.Ih());
    ...
    v.fo = function() {
        ...
        b.Bp = function(b) {
            ...
            k.ig = function(a) {
                e = a;
                t.yg = v.Xh(a, null != k.Hb);
                h || (h = !0,
                x.Sa(t.j.g))
            }
            ;
            t.Fh.Fp = function(a, b, c, d) {
                k.lo(a, b, c, d)
            }
            ;
            t.Fh.Gp = function() {
        ...
        try {
            ...
            var h = function(a, b) {
              ...
              , m = function() {
                var b = new ca(k);
                k.$k = function(a) {
                    b.j.ne.lr((10 * k.pg.Xg(.5) | 0) / 10);
                    b.j.ne.jr((10 * k.pg.max() | 0) / 10);
                    b.j.ne.jl.mn(a)
                }
                ;
                b.yg = v.Xh(a, !1);
    ...
    x.cj = function(a) {
        x.es() && x.$r(function() {
            ...
            return Promise.all([N.L("res.dat", "arraybuffer").then(function(a) {
                a = new JSZip(a);
                n.Ma = new Vb(a);
                return Promise.all([n.Ma.jo, x.Tg(a.file("images/grass.png").asArrayBuffer()).then(function(a) {
                    return n.Co = a
                }), x.Tg(a.file("images/concrete.png").asArrayBuffer()).then(function(a) {
                    return n.On = a
                }), x.Tg(a.file("images/concrete2.png").asArrayBuffer()).then(function(a) {
                    return n.Mn = a
                }), x.Tg(a.file("images/typing.png").asArrayBuffer()).then(function(a) {
                    return n.um = a
                })])
            }), b]).then(function() {
                x.ps(a)
    ...
    x.$r = function(a) {
        ...
        x.Mg = window.document.createElement("div"),
        window.document.body.appendChild(x.Mg),
        a = new Wa(d),
        x.Sa(a.g)) : a()
    }
    ;
    ...
    aa.get = function(a) {
        return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(b, c) {
            ...
            d.onsuccess = function() {
                ...
                ;
                zb.ah(f.objectStore("files").get(a)).then(function(a) {
                    try {
                        var d = new h;
                        d.Hk(a);
                        b(d)
    ...
    aa.getAll = function() {
        return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(a, b) {
            ...
            c.onsuccess = function() {
                ...
                ;
                zb.ah(e.objectStore("meta").getAll()).then(a, b)
            }
        }
        )
    }
    ...
    aa.add = function(a) {
        return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(b, c) {
            ...
            d.onsuccess = function() {
                ...
                ;
                try {
                    zb.ah(f.objectStore("files").add(a.re())).then(function(b) {
                        b = {
                            name: a.w,
                            id: b
                        };
                        return zb.ah(f.objectStore("meta").add(b))
                    })["catch"](c)
                } catch (g) {
                    c(0)
                }
    ...
    Ub.prototype = {
        update: function() {
            var a = window.performance.now()
              , b = a - this.Lm;
            this.Lm = a;
            this.ue += (this.$g - this.ue) * this.Es;
            this.Cf -= b;
            0 >= this.Cf && (this.Cf = this.$g = 0);
            0 >= this.$g && .05 > this.ue && (window.clearInterval(this.dh),
            this.dh = null,
            this.ue = 0);
            this.Qg.gain.value = n.A.em.L() ? this.ue : 0
        },
        nj: function(a) {
            var b = this;
            this.$g = a;
            this.Cf = 166.66666666666666;
            null == this.dh && (this.dh = window.setInterval(function() {
                b.update()
            }, 17),
    ...
    O.prototype = {
        ...
        yk: function(a) {
            if (a.ca == q.Ia)
                ...
                0 == d.length ? (b.a.x = a.ca.zh * this.S.$b,
                b.a.y = 0) : (a = b.a,
                d = d[d.length - 1],
                a.x = d.x,
                a.y = d.y);
    ...
    h.ar = function(a, b) {
        ...
        h.ia(c, "bias", a.Cc, b.Cc);
        h.ia(c, "bCoef", a.m, b.m);
        var d = a.uo();
        h.ia(c, "curve", d, 0);
        0 != d && (c.curveF = a.ub);
        h.ia(c, "vis", a.Xa, b.Xa);
    ...
    h.aq = function(a) {
        ...
        h.ia(b, "bCoef", a.m, .5);
        h.ia(b, "invMass", a.$, .5);
        h.ia(b, "damping", a.Ca, .96);
        h.ia(b, "acceleration", a.Be, .1);
        h.ia(b, "kickingAcceleration", a.Se, .07);
        h.ia(b, "kickingDamping", a.Te, .96);
        h.ia(b, "kickStrength", a.Qe, 5);
        h.Ic(b, "cGroup", a.v, 0);
        if (0 != a.oa.x || 0 != a.oa.y)
            b.gravity = [a.oa.x, a.oa.y];
        h.ia(b, "radius", a.Y, 15);
        h.ia(b, "kickback", a.Re, 0);
        return b
    }
    ;
    h.cp = function(a) {
    ...
    h.eo = function(a, b) {
        ...
        h.ia(c, "radius", a.Y, b.Y);
        h.ia(c, "bCoef", a.m, b.m);
        h.ia(c, "invMass", a.$, b.$);
        h.ia(c, "damping", a.Ca, b.Ca);
        h.di(c, a.R, b.R);
        h.Ic(c, "cMask", a.h, b.h);
        h.Ic(c, "cGroup", a.v, b.v);
        return c
    ...
    h.prototype = {
        ...
        Cr: function() {
            ...
            h.ia(c, "maxViewWidth", this.Xe, 0);
            h.ia(c, "cameraFollow", 1 == this.Ee ? "player" : "", "");
            h.ia(c, "spawnDistance", this.kc, 200);
            0 != l.length && (c.joints = l);
            0 != k.length && (c.redSpawnPoints = k);
            0 != t.length && (c.blueSpawnPoints = t);
            h.ia(c, "kickOffReset", this.mf ? "full" : "partial", "partial");
            switch (this.ld) {
            case 1:
                b = "grass";
                break;
            ...
            h.ia(a, "type", b, "none");
            h.ia(a, "width", this.Sd, 0);
            h.ia(a, "height", this.Rd, 0);
            h.ia(a, "kickOffRadius", this.kd, 0);
            h.ia(a, "cornerRadius", this.Sc, 0);
            h.ia(a, "color", this.jd, 7441498);
            h.ia(a, "goalLine", this.De, 0);
            return c
        },
        Hk: function(a) {
            function b(a) {
    ...
    ta.prototype = C(m.prototype, {
        apply: function(a) {
            var b = a.na(this.P);
            null != b && this.Vg != b.Kd && (b.Kd = this.Vg,
            y.i(a.ol, b))
        },
        ua: function(a) {
            a.l(this.Vg ? 1 : 0)
    ...
    sa.prototype = C(m.prototype, {
        apply: function(a) {
            if (a.Kb(this.P, 4)) {
                var b = a.na(this.P)
                  , c = a.na(this.Ld);
                null != c && 0 != c.V && c.bb != this.Ug && (c.bb = this.Ug,
                null != a.gi && a.gi(b, c))
            }
        },
        ua: function(a) {
    ...
    qa.prototype = C(m.prototype, {
        ...
        va: function(a) {
            ...
            this.Od = h.ka(new F(new DataView(a.buffer,a.byteOffset,a.byteLength)))
        },
        f: qa
    });
    Pa.b = !0;
    ...
    Pa.prototype = C(m.prototype, {
        apply: function(a) {
            a.Kb(this.P, 2) && this.ca != q.Ia && (a.jb[this.ca.Z] = this.Pg)
        },
        ua: function(a) {
            a.l(this.ca.Z);
            this.Pg.ea(a)
    ...
    qb.prototype = C(m.prototype, {
        ...
        ua: function(a) {
            a.l(this.Qm ? 1 : 0);
            a.l(this.Wg.length);
            for (var b = 0, c = this.Wg; b < c.length; )
                a.O(c[b++])
        },
        va: function(a) {
            this.Qm = 0 != a.B();
    ...
    E.prototype = {
        ...
        fe: function() {
            if (0 == 0 * this.ub) {
                ...
                c = this.W.a;
                a = this.Vd;
                this.Eg = new H(-(c.y - a.y),c.x - a.x);
                c = this.Vd;
                a = this.aa.a;
                this.Fg = new H(-(c.y - a.y),c.x - a.x);
                0 >= this.ub && (a = c = this.Eg,
                c.x = -a.x,
                c.y = -a.y,
                a = c = this.Fg,
                c.x = -a.x,
    ...
    M.prototype = {
        ...
        Kr: function() {
            if (null != this.sa.parentElement) {
                var a = window.devicePixelRatio * this.wg
        ...
        Jc: function(a, b) {
            ...
            if (null != a.K) {
                var c = a.K
                  ...
                  , f = a.na(b)
                  , g = null != f ? f.H : null
                  , l = 0 != this.hf ? this.sa.height / this.hf : this.jf * window.devicePixelRatio * this.wg
                  , k = this.vf * this.wg
                  , h = c.S.Xe
                  , m = this.sa.width / l;
                0 < h && m > h && (m = h,
                ...
                for (e = e.F; f < e.length; )
                    g = e[f],
                    ++f,
                    null == this.Gg.get(g) && this.Gl(g, null);
                this.c.lineWidth = 3;
                this.c.resetTransform();
        ...
        Gl: function(a, b) {
            ...
            this.c.strokeStyle = "black") : (this.c.fillStyle = b.Ej,
        ...
        C: function(a, b) {
            if (null != a.H) {
                var c = n.A.om.L() ? b.jb[a.ca.Z] : a.ca.nm
                  ...
                  , e = n.A.cm.L() && null != d;
                if (!Fa.En(this.jb, c) || !e && a.Ib != this.qh || e && this.If != d)
                    Fa.Un(this.jb, c),
                    e ? (this.If = d,
                    this.qh = -1) : (this.If = "" + a.Ib,
                    this.qh = a.Ib),
                    this.Cq(this.If)
            }
    ...
    ja.prototype = {
        C: function(a) {
            ...
            A.i(this.ul);
            this.Zh.disabled = null == a.T.K;
            this.Gd ? this.Va.C(a.T, a.T.na(a.uc)) : (a = a.Qf(),
            this.Eb.C(a),
            n.Ma.Tj.Gs(a))
        },
        ke: function(a) {
            this.Gd != a && ((this.Gd = a) ? (this.Gh.appendChild(this.Va.g),
            this.Eb.g.remove()) : (this.Gh.appendChild(this.Eb.g),
            this.Va.g.remove()))
        },
        Ro: function() {
            return null != ja.bq
    ...
    eb.prototype = {
        ...
        ii: function(a) {
            for (var b = this, c = h.Hh(), d = 0; d < c.length; ) {
                var e = [c[d]];
                ++d;
    ...
    Rb.prototype = {
        mn: function(a) {
            ...
            this.Bh.clearRect(0, 0, b, c);
            this.Bh.drawImage(this.sa, b - d - 1, 0);
            this.Bh.drawImage(this.sa, -d - 1, 0)
        },
        f: Rb
    };
    db.b = !0;
    ...
    Ya.prototype = {
        ...
        C: function(a, b) {
            ...
            this.Ll.disabled = d;
            this.Uh != a.Oc && this.xj(a.Oc);
            d && (c = 120 == a.K.Na,
            this.hl != c && this.yj(c))
        },
        xj: function(a) {
            this.Uh = a;
            this.Jk.innerHTML = this.Uh ? "<i class='icon-lock'></i>Unlock" : "<i class='icon-lock-open'></i>Lock"
        },
        yj: function(a) {
            this.hl = a;
    ...
    Xa.prototype = {
        lr: function(a) {
            this.og.textContent = null == a ? "null" : "" + a
        },
        jr: function(a) {
        ...
        default:
            if (null != a)
                if ("function" == typeof b) {
                    if (a instanceof b || r.lh(r.Em(a), b))
                        return !0
                } else {
